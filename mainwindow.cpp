 ...
 ui->tableView->setModel(Etmp.afficher());
   ...
   QRegExpValidator *dateValidator = new QRegExpValidator(QRegExp("[0-9]{1,2}/[0-9]{1,2}/[0-9]{4}"), this);
       ui->ledate->setValidator(dateValidator);
        ...
        QMetaObject::invokeMethod(this, "on_recherche_clicked", Qt::QueuedConnection);
        ui->recherche->setVisible(false);
...
void ArtNexus::on_pushButton_14_clicked()
{
    QSqlQuery query;
    ...
    if (query.exec())
    {
        ...
        Dialog *dialog = new class Dialog(this);
        dialog->setChartData1(percentagePerDomain);
        dialog->exec();
    }
}
...
void ArtNexus::sortData(int index) {
    ...
    ui->tableView_Association->setModel(Ctemp.tri1(columnName));
}
